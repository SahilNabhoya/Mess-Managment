    ...
    <header>
      <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
        ...
        <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
          <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="adminhome.php">Dashbord</a>
          <a class="me-3 py-2 link-body-emphasis text-decoration-none" id="active" href="menuadmin.php">Menu</a>
    ...
    <?php
      ...
      if($result){
        while($row = mysqli_fetch_assoc($result)){
          ...
          <td>'.$Lunch.'</td>
          <td>'.$Dinner.'</td>
          <td><button type="button" class="btn btn-primary"><a href="update.php?updateid='.$id.'" class="text-light">Update</a></button></td>
        </tr>';
        }
      }
    ?>
