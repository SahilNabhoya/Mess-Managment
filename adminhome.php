    ...
    <header>
      <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
        ...
        <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
          ...
          <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="menuadmin.php">Menu</a>
          <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="user/account.php">Account</a>
      ...
      <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
        <h3 class="display-6 fw-normal">Dashbord</h3>
        ...
        <div class="col">
          <div class="card mb-4 rounded-3 shadow-sm">
            <div class="card-header py-3">
              <h4 class="my-0 fw-normal">Our Varites</h4>
            </div>
            <div class="card-body">
              <ul class="list-unstyled mt-3 mb-4">
              <?php
        $sql1="Select count(*) as count from `item`";
        $result2 = mysqli_query($conn,$sql1);
        $row = mysqli_fetch_assoc($result2);
        $count1 = $row["count"];
        echo'<li><a href="item.php">'.$count1.' Items included</a></li>';
        ?>
        ...
        <div class="col">
          <div class="card mb-4 rounded-3 shadow-sm">
            ...
            <div class="card-body">
              <ul class="list-unstyled mt-3 mb-4">
        <?php
        $sql1="Select count(*) as count from `userlogin`";
        $result1 = mysqli_query($conn,$sql1);
        $row = mysqli_fetch_assoc($result1);
        $count = $row["count"];
        echo'<li><a href="student.php">'.$count.' students</a></li>';
        ?>
              </ul>
            </div>
          </div>
