...
<body>
    ...
    <div class="content">
        ...
        <form class="form" action="sign_up.php" method="post">
            <h5>we sent varification to your gmail account</h5>

            <input type="text" id="email" name="email" placeholder="Enter Verification code " required>
            

            <button class="btnn"><a>Verify</a></button>
